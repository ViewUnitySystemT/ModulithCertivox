...
export default function Home() {
  const [pageLoaded, setPageLoaded] = useState(true); // Always start as loaded
  const [commandPaletteOpen, setCommandPaletteOpen] = useState(false);

  // Simplified store access - use defaults if stores fail
  let mode = 'classic';
  ...
  try {
    ...
    // Use defaults - don't prevent page from loading
  }
